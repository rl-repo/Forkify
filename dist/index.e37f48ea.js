...
function init() {
    (0, _bookmarksViewsJsDefault.default).addHandlerRender(controlBookmarks);
...
},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./config.js":"k5Hzs","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/paginationView.js":"6z7bi","./views/bookmarksViews.js":"adBr1","./views/addRecipeView.js":"i6DNj","regenerator-runtime/runtime":"dXNgZ","regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
...
const KEY = "f7967da2-321b-4a65-91c3-e6531ed249d7";
...
export const getJSON = async function (url) {
	try {
		...
		throw err; // throw to error in model
	}
};
        ...
        <div class="recipe__details">
          ...
          <div class="recipe__info">
            ...
            <div class="recipe__info-buttons">
              <button id="decServing" class="btn--tiny btn--update-servings" data-update-to="${this._data.servings - 1}">
                <svg>
...
class View {
	 ...
	 * @param {boolean} {render = true} If false, create markup str instead of rendering to DOM
	 * @returns {undefined | string} Markup str returned if render == false
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (curPage === 1 && numPages > 1) return this._generatePageButton("next", curPage);
        // Last page
        if (curPage === numPages && numPages > 1) return this._generatePageButton("prev", curPage);
        // Other pages
    ...
    _generatePageButton(dir, page) {
        ...
        <button data-goto="${tempPage}"
            ...
            <svg class="search__icon">
                <use href="${0, _iconsSvgDefault.default}#icon-arrow-${dir === "prev" ? "left" : "right"}"></use>
            </svg>
...
},{"./View.js":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"adBr1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
